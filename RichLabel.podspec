...
Pod::Spec.new do |s|
  s.name             = 'RichLabel'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RichLabel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/fengming/RichLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'fengming' => '1028708571@qq.com' }
  s.source           = { :git => 'https://github.com/fengming/RichLabel.git', :tag => s.version.to_s }
